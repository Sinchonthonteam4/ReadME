...
|      주한아 <br/> **(기획/디자인)**       |       서가영 <br/> **(개발/프론트엔드)**          |       장세환 <br/> **(개발/프론트엔드)**          |       진규빈 <br/> **(개발/백엔드)**        |       김유이  <br/> **(개발/백엔드)**       |       김희선 <br/> **(개발/백엔드)**        |       이상 <br/> **(개발/백엔드)**        |                                                                                                              
| :------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------: | 
...
| 홍익대학교 경영학  | 홍익대학교 컴퓨터공학 | 서강대학교 생명공학 | 이화여자대학교 유럽문화학 | 서강대학교 국어국문학 | 연세대학교 컴퓨터공학 | 홍익대학교 컴퓨터공학 |
